        ...
        return (
            <div className="col-lg-8 mt-3">
                <div className="job-item">
                    {this.props.jobs.length>0?this.showJobs(jobs):(this.props.search_value.loading?"":<div><img className="center my-5" src={img} alt="" width="200px" /><h2 className="h2 text-center text-muted">Không tìm thấy ứng viên</h2></div>)}
