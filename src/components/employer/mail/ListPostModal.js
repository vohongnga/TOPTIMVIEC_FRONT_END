          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              {listPost.map((list, index) => (
                <Link to="#" data-aos="fade-right" key={index} onClick={()=>this.onChoosePost(list)}>
                  <div className="item row h-30 full-width mx-1 mb-3 rounded bg-grey big-hover ct_post">
